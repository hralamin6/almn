        ...
        <div style="">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;text-transform: capitalize">
                ...
                <tr style="background-color: #f2f2f2;">
                    ...
                    <th style="text-transform: capitalize; padding: 10px; border: 1px solid #ddd;">@lang('Male name')</th>
                    <th style="text-transform: capitalize; padding: 10px; border: 1px solid #ddd;">@lang('Female name')</th>
                ...
                @forelse($items as $i => $item)
                    ...
                    <tr style="border: 1px solid #ddd;">
                        ...
                        <td style="text-transform: capitalize; padding: 10px; border: 1px solid #ddd;">{{$item->meaning}}</td>
                        <td style="text-transform: capitalize; padding: 10px; border: 1px solid #ddd;">{{$item->male_name}}</td>
                        <td style="text-transform: capitalize; padding: 10px; border: 1px solid #ddd;">{{$item->female_name}}</td>
