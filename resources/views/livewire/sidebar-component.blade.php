        ...
        <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
            ...
            <div x-data="{ isActive: true, open: true}">
                ...
                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                    ...
                    <a
                        href="{{route('login')}}" wire:navigate role="menuitem"
                        class="block p-2 text-sm {{Route::is('login')?'text-gray-700 dark:text-light':'text-gray-400'}} transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                    >
                        @lang('login')
                    </a>
                    <a
                        href="{{route('register')}}" wire:navigate role="menuitem"
                        class="block p-2 text-sm {{Route::is('register')?'text-gray-700 dark:text-light':'text-gray-400'}} transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                    >
                        @lang('register')
                    </a>
                    <a
                        href="{{route('home')}}" wire:navigate role="menuitem"
                        class="block p-2 text-sm {{Route::is('home')?'text-gray-700 dark:text-light':'text-gray-400'}} transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                    >
                        @lang('home')
                    </a>
                    <a
