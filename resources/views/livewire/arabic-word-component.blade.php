                        ...
                        <div class=" border border-gray-200 dark:border-gray-700 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                @forelse($items as $i => $item)
                                    ...
                                    <tr @if($loadId==$item->id) wire:scroll @endif id="item-id-{{$item->id}}"
                                        class="@if($loadId==$item->id) dark:bg-gray-500 bg-green-100 animate-pulse @endif text-gray-700 dark:text-gray-300 capitalize"
                                        :class="{'bg-gray-200 dark:bg-gray-600': rows.includes('{{$item->id}}') }">
                                        <td class="pl-2">
                                            <input x-model="rows" value="{{$item->id}}" id="{{ $item->id }}"
                                                   type="checkbox"
                                                   class="justify-between text-blue-500 border-gray-300 rounded dark:bg-darker dark:ring-offset-gray-900 dark:border-gray-700">
                                        </td>
                                                                        ...
                                                                        <div class="container mx-auto p-6">
                                                                            <div class="overflow-x-auto">
                                                                                <table
                                                                                    ...
                                                                                    @foreach(['baab', 'masdar', 'madee', 'mudaree', 'amr', 'nahee', 'ismul_fel'] as $key)
                                                                                        <tr>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $keyMap[$key] }}</td>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $item->data[$key] ?? '' }}</td>
                                                                                        </tr>
                                                                                    @endforeach
                                                                                    </tbody>
                                                                                    ...
                                                                                    <tbody x-show="open === 'madee'"
                                                                                           class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                                    @foreach(['madee_gaaib_male_oheed', 'madee_gaaib_male_tasnia', 'madee_gaaib_male_jama', 'madee_gaaib_female_oheed', 'madee_gaaib_female_tasnia', 'madee_gaaib_female_jama', 'madee_haader_male_oheed', 'madee_haader_male_tasnia', 'madee_haader_male_jama', 'madee_haader_female_oheed', 'madee_haader_female_tasnia', 'madee_haader_female_jama', 'madee_mutakallim_oheed', 'madee_mutakallim_jama'] as $key)
                                                                                        <tr>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $keyMap[$key] }}</td>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $item->data[$key] ?? '' }}</td>
                                                                                        </tr>
                                                                                    ...
                                                                                    <tbody x-show="open === 'mudaree'"
                                                                                           class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                                    @foreach(['mudaree_gaaib_male_oheed', 'mudaree_gaaib_male_tasnia', 'mudaree_gaaib_male_jama', 'mudaree_gaaib_female_oheed', 'mudaree_gaaib_female_tasnia', 'mudaree_gaaib_female_jama', 'mudaree_haader_male_oheed', 'mudaree_haader_male_tasnia', 'mudaree_haader_male_jama', 'mudaree_haader_female_oheed', 'mudaree_haader_female_tasnia', 'mudaree_haader_female_jama', 'mudaree_mutakallim_oheed', 'mudaree_mutakallim_jama'] as $key)
                                                                                        <tr>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $keyMap[$key] }}</td>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $item->data[$key] ?? '' }}</td>
                                                                                        </tr>
                                                                                    ...
                                                                                    <tbody x-show="open === 'amr'"
                                                                                           class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                                    @foreach(['amr_gaaib_male_oheed', 'amr_gaaib_male_tasnia', 'amr_gaaib_male_jama', 'amr_gaaib_female_oheed', 'amr_gaaib_female_tasnia', 'amr_gaaib_female_jama', 'amr_haader_male_oheed', 'amr_haader_male_tasnia', 'amr_haader_male_jama', 'amr_haader_female_oheed', 'amr_haader_female_tasnia', 'amr_haader_female_jama'] as $key)
                                                                                        <tr>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $keyMap[$key] }}</td>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $item->data[$key] ?? '' }}</td>
                                                                                        </tr>
                                                                                    ...
                                                                                    <tbody x-show="open === 'ismul_fel'"
                                                                                           class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                                    @foreach(['ismul_fel_male_oheed', 'ismul_fel_male_tasnia', 'ismul_fel_male_jama', 'ismul_fel_female_oheed', 'ismul_fel_female_tasnia', 'ismul_fel_female_jama'] as $key)
                                                                                        <tr>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $keyMap[$key] }}</td>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $item->data[$key] ?? '' }}</td>
                                                                                        </tr>
                                                                                    ...
                                                                                    <tbody
                                                                                        ...
                                                                                        class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                                    @foreach(['ismul_maful_male_oheed', 'ismul_maful_male_tasnia', 'ismul_maful_male_jama', 'ismul_maful_female_oheed', 'ismul_maful_female_tasnia', 'ismul_maful_female_jama'] as $key)
                                                                                        <tr>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $keyMap[$key] }}</td>
                                                                                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-300">{{ $item->data[$key] ?? '' }}</td>
                                                                                        </tr>
