    ...
    <main class="h-full">
        ...
        <section class="container px-4 mx-auto">
                                ...
                                @forelse($items as $i => $item)
                                        ...
                                        <div class="inline-flex items-center gap-x-3">
                                            ...
                                            <div class="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm font-normal text-gray-600 dark:text-gray-400">{{ $item->name }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                        <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                            ...
                                            <h2 class="text-sm font-normal text-emerald-500">{{ $item->status }}</h2>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ $item->type }}</td>
            ...
            <div class="flex items-center justify-between mt-6">
                <a href="#" class="flex items-center px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md gap-x-2 hover:bg-gray-100 dark:bg-darker dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800">
