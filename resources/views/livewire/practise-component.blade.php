<div>
    ...
    <div class="flex flex-1 h-full p-4">
        ...
        @auth
            ...
            <a href="{{route('test')}}?practise=word_to_details" wire:navigate class="m-1 bg-gradient-to-r from-purple-500 to-pink-500 flex gap-x-3 text-sm capitalize sm:text-base items-center justify-center text-white rounded-lg hover:bg-[#1877F2]/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                <span>@lang('verb to details')</span>
            </a>
            <a href="{{route('test')}}?practise=details_to_verb" wire:navigate class="m-1 bg-gradient-to-r from-purple-500 to-pink-500 flex gap-x-3 text-sm capitalize sm:text-base items-center justify-center text-white rounded-lg hover:bg-[#1877F2]/80 duration-300 transition-colors border border-transparent px-8 py-2.5">
                <span>@lang('details to verb')</span>
            </a>
        </div>
