...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!--[if BLOCK]><![endif]--><?php if(Route::has('register')): ?>
                <div class="text-sm text-gray-600 dark:text-gray-400">
                    Don't have an account yet? <a href="<?php echo e(route('register')); ?>" wire:navigate class="text-blue-600 hover:underline">Register</a>
                </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    </main>
</div>
<?php /**PATH C:\xampp\htdocs\almn\resources\views/livewire/auth/adminlogin.blade.php ENDPATH**/ ?>