    ...
    <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
        ...
        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
            ...
            <div class="relative inline-block text-left" x-data="{lang:false}">
                ...
                <div x-cloak x-show="lang" @click.outside="lang=false" @click="lang=false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-xl shadow-lg">
                    <div class="rounded-md bg-white dark:bg-dark shadow-xs">
                        <div class="py-1">
                            <a wire:click="$set('locale', 'bn')" class="block px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 <?php echo e(session()->get('locale')=='bn'?'bg-gray-300 dark:dark:bg-darker':''); ?> hover:dark:bg-gray-500 hover:bg-gray-300 focus:outline-none focus:bg-gray-300 transition duration-150 ease-in-out"><?php echo app('translator')->get('bangla'); ?></a>
                            <a wire:click="$set('locale', 'en')" class="block px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 <?php echo e(session()->get('locale')=='en'?'bg-gray-300 dark:dark:bg-darker':''); ?> hover:dark:bg-gray-500 hover:bg-gray-300 focus:outline-none focus:bg-gray-300 transition duration-150 ease-in-out"><?php echo app('translator')->get('english'); ?></a>
                            <a wire:click="$set('locale', 'ar')" class="block px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-300 <?php echo e(session()->get('locale')=='ar'?'bg-gray-300 dark:dark:bg-darker':''); ?> hover:dark:bg-gray-500 hover:bg-gray-300 focus:outline-none focus:bg-gray-300 transition duration-150 ease-in-out"><?php echo app('translator')->get('arabic'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                >
                    <a href="<?php echo e(route('wishlists')); ?>" wire:navigate role="menuitem"
                        class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
                    ><?php echo app('translator')->get('wishllists'); ?></a>
                    <a href="<?php echo e(route('quizzes')); ?>" wire:navigate role="menuitem"
                        class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
                    ><?php echo app('translator')->get('previous exams'); ?></a>
                    <a
                        href="<?php echo e(route('logout')); ?>" wire:navigate
                        role="menuitem"
                        class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"
                    >
...
<?php /**PATH /home/hralamin/www/almn/resources/views/livewire/header-component.blade.php ENDPATH**/ ?>