                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $item->options($item, $practise); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <label class="flex items-center text-sm">
                                        ...
                                        <span class="ml-3 text-md font-medium"><?php echo e(is_numeric($option[$practise])?number_format($option[$practise], 2):$option[$practise]); ?></span>
                                    </label>
                                </li>
                        ...
                        <li>
                            <label class="flex items-center text-sm">
                                ...
                                <span class="ml-3 text-md font-medium text-gray-800">Your ans:
                                        <span
                                            class="<?php echo e($col === $a ?'text-green-600 dark:text-green-600':'text-pink-600'); ?>"><?php echo e($ans[$i]?is_numeric($ans[$i])?number_format($ans[$i], 2):$ans[$i]:'no answer'); ?></span>
                                    </span>
                            </label>
                        </li>
                        <li>
                            <label class="flex items-center text-sm">
                                    <span class="ml-3 text-md font-medium text-gray-800">Correct ans:
                                        <span class="text-green-600"><?php echo e(is_numeric($item[$practise])?number_format($item[$practise], 2):$item[$practise]); ?></span>
                                    </span>
                            </label>
                        </li>
                    </ul>
...
<?php /**PATH C:\xampp\htdocs\almn\resources\views/livewire/exam-component.blade.php ENDPATH**/ ?>