<div>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <section class="text-center mt-8">
            <a href="<?php echo e(route('words')); ?>" wire:navigate class="px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700">আজই আরবি শব্দভান্ডার শেখা শুরু করুন!</a>
        </section>
    </main>
...
<?php /**PATH C:\xampp\htdocs\almn\resources\views/livewire/home-component.blade.php ENDPATH**/ ?>