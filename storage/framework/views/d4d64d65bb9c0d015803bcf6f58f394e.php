...
[$__name, $__params] = $__split('sidebar-component', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2254351634-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('header-component', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2254351634-1', $__slots ?? [], get_defined_vars());
                    ...
                    <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                      ...
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                            ...
                            src="<?php echo e(asset('images/avatar.jpg')); ?>"
                            alt="Ahmed kamel"
                        />
                      </span>
                                    <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
              ...
              <span class="absolute inset-y-0 inline-flex items-center px-4">
                ...
                <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                    ...
                    <a href="#" class="flex space-x-4">
                        <div class="flex-shrink-0">
                            <img class="w-10 h-10 rounded-lg" src="i<?php echo e(asset('mages/cover.jpg')); ?>" alt="Post cover" />
                        </div>
                    ...
                    <a href="#" class="flex space-x-4">
                        <div class="flex-shrink-0">
                            <img class="w-10 h-10 rounded-lg" src="<?php echo e(asset('images/avatar.jpg')); ?>" alt="Ahmed Kamel" />
                        </div>
                        <div class="flex-1 max-w-xs overflow-hidden">
                    ...
                    <a href="#" class="flex space-x-4">
                        <div class="flex-shrink-0">
                            <img class="w-10 h-10 rounded-lg" src="i<?php echo e(asset('mages/cover-2.jpg')); ?>" alt="K-WD Dashboard" />
                        </div>
                        <div class="flex-1 max-w-xs overflow-hidden">
                    ...
                    <template x-for="i in 10" x-key="i">
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="i<?php echo e(asset('mages/cover-3.jpg')); ?>" alt="K-WD Dashboard" />
                            </div>
                            <div class="flex-1 max-w-xs overflow-hidden">
                                <h4 class="text-sm font-semibold text-gray-600 dark:text-light">K-WD Dashboard</h4>
                                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
...
<?php echo $__env->make('components.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hralamin/www/almn/resources/views/components/layouts/app.blade.php ENDPATH**/ ?>