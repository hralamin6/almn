...
<div class="m-2 md:w-1/2  items-center m-auto text-sm dark:text-white">
        ...
        <a href="<?php echo e(route('exam')); ?>?practise=name" wire:navigate class="px-2 py-1 text-2xl text-pink-50 rounded-xl justify-center mt-4 text-center bg-green-600"><?php echo app('translator')->get('Start now'); ?></a>
    </div>
