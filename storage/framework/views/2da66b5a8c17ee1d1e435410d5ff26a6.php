                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('isAdmin')): ?>
                                            <td class="px-12 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div
                                                    ...
                                                    <button type="button" wire:click="changeStatus(<?php echo e($item->id); ?>)"
                                                            class="cursor-pointer text-sm font-normal <?php echo e($item->status=='active'?'text-emerald-500':'text-pink-500'); ?> "><?php echo e($item->status); ?></button>
                                                </div>
                                            </td>
                                            <td class="px-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div class="inline-flex items-center gap-x-3">
